...
<head>
    ...
    <title>Absensi Izin Nihonbuni</title>
    <style>
...
<body>
    <div class="container">
        <h1 class="title">Absensi Izin JC</h1>
        <div class="card">
            <div class="logo">
            ...
            <div id="form" class="card-form closed" >
                <form action="public/izin/insert.php" method="POST">
                    ...
                    <div class="input-form">
                            ...
                            <textarea name="keterangan" id="" cols="30" rows="8"></textarea>
                    </div>
                    <input type="submit">
                </form>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            const formIzinOpen = localStorage.getItem("formIzinOpen") === "true";
